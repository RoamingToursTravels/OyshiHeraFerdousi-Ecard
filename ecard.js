...
function saveContact() {
    const name = 'Oyshi Hera Ferdousi ';
    const organization = 'Roaming Tours & Travels';
    const title = 'Operation Manager';
    const officePhone = '01329739730';
    const personalPhone = '01671744084';
    const email = 'oyshiroamingbd2025@gmail.com';
...
function openWhatsApp() {
    const whatsappNumber = '8801329739730';
